...
// Follow make an user follow another
...
// Unfollow make an user stop follow another
...
// GetFollowers returns all followers from an user
...
// UpdatePassword allow users to update their password
func UpdatePassword(w http.ResponseWriter, r *http.Request) {
	...
	if err = security.Compare(storedPassword, password.Current); err != nil {
		responses.Error(w, http.StatusUnauthorized, errWrongPassword)
		return
	}
